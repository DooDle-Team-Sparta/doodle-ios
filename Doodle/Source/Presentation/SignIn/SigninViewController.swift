...
final class SigninViewController: UIViewController {
    ...
    private lazy var passwordSecureButton: UIButton = {
        ...
        button.setImage(UIImage(named: "eyeslashfill"), for: .normal)
...
//        stackView.alignment = .fill
    ...
    private func setUpConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            // 이메일 텍스트뷰
            emailTextFieldView.topAnchor.constraint(equalTo: doodleImageView.bottomAnchor, constant: 100),
            ...
            passwordSecureButton.widthAnchor.constraint(equalToConstant: 35),
            passwordSecureButton.heightAnchor.constraint(equalToConstant: 35),
...
// MARK: SigninViewController class 끝
...
extension SigninViewController: UITextFieldDelegate {
    ...
    func textFieldDidBeginEditing(_ textField: UITextField) {
        if textField == idTextField {
            ...
            emailInfoLabel.font = UIFont.systemFont(ofSize: 12)
            // 레이아웃 변화
            emailInfoLabelCenterYConstraint.constant = -13
        }
        if textField == pwTextField {
            passwordTextFieldView.backgroundColor = .white
            passwordInfoLabel.font = UIFont.systemFont(ofSize: 12)
